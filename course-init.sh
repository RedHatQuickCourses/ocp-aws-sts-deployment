...
execute_init()
{
	...
	sed -i "s/ocp-aws-sts-deployment/${REPONAME}/g" *.* > /dev/null 2>&1
	sed -i "s/ocp-aws-sts-deployment/${REPONAME}/g" supplemental-ui/partials/header-content.hbs > /dev/null 2>&1
	echo -e "done"
